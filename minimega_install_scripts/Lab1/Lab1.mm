...
vm config cdrom /opt/minimega/cyberlab/vms/pfSense-CE-2.4.4-RELEASE-amd64.iso 
...
###Kali
clear vm config
disk create qcow2 kali-linux-2019.2-amd64.qcow2 20G
vm config disk /opt/minimega/images/kali-linux.qcow2
vm config cdrom /opt/minimega/images/iso/kali-linux-2019.2-amd64.iso 
vm config memory 2048
vm config net LAN
vm config snapshot false
vm config qemu-append -vga qxl
